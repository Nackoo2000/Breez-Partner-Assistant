...
const stmtTouchGroup = db.prepare(`
  INSERT INTO telegram_groups (chat_id, chat_title)
  VALUES (?, ?)
  ON CONFLICT(chat_id) DO UPDATE SET chat_title = excluded.chat_title
`);

export function touchTelegramGroup(chatId, chatTitle) {
  stmtTouchGroup.run(chatId, chatTitle);
}
